  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-r from-blue-500 via-purple-500 to-indigo-600 px-6">
      <Motion.div
        ...
        className="flex flex-col md:flex-row items-center gap-10 bg-white/10 backdrop-blur-lg rounded-2xl p-10 shadow-xl"
      >
        ...
        >
          <Motion.div
            ...
            className="w-40 h-40 md:w-56 md:h-56 rounded-full bg-white flex items-center justify-center shadow-lg overflow-hidden"
          >
            ...
            <span className="text-gray-400 text-xl">Your Image</span>
          </Motion.div>
        </Motion.div>
        ...
        >
          ...
          <h2 className="text-2xl md:text-3xl font-semibold mb-4">FullStack Developer</h2>
